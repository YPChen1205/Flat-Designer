package de.chen.flatdesigner.figures.handle;
...
public class ArcNodeHandle extends AbstractHandle {
     ...
     */
    public ArcNodeHandle(BezierFigure owner, int index) {
        this(owner, index, owner);
    }

    public ArcNodeHandle(BezierFigure owner, int index, Figure transformOwner) {
        super(owner);
        this.index = index;
